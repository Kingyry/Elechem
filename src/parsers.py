...
class ORCA_parser:
    ...
    def smiles(self):
        ...
        '''
        write('gen_structure.pdb',images = self.geometry())
        molecule = Chem.MolFromPDBFile('gen_structure.pdb')
        smiles = Chem.MolToSmiles(molecule)
        os.remove('gen_structure.pdb')
        return smiles

    def formula(self):
        '''
        Returns chemical formula of the molecule
        '''
